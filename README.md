<div align="center">
<p>
<h1> @skyra/discord-message-components </h1>
<h3> React components for creating Discord messages </h3>
</p>
<p>
	<a href="https://github.com/skyra-project/discord-message-components/blob/master/LICENSE.md">
	<img src="https://img.shields.io/github/license/skyra-project/discord-message-components?logo=github&maxAge=3600&style=flat-square" alt="NPM version" />
	</a>
</p>
<p>
<a href="https://www.npmjs.com/package/@skyra/discord-message-components">
<img src="https://img.shields.io/npm/v/@skyra/discord-message-components.svg?maxAge=3600&logo=npm&style=flat-square" alt="NPM version" />
</a>
	
<a href="https://www.npmjs.com/package/@skyra/discord-message-components">
<img src="https://img.shields.io/npm/dt/@skyra/discord-message-components.svg?maxAge=3600&logo=npm&style=flat-square" alt="NPM downloads" />
</a>
</p>
<p>
<a href="https://bundlephobia.com/result?p=@skyra/discord-message-components">
<img src="https://img.shields.io/bundlephobia/min/@skyra/discord-message-components?label=minified&logo=webpack&maxAge=3600&style=flat-square" alt="Minified Size">
</a>

<a href="https://bundlephobia.com/result?p=@skyra/discord-message-components">
<img src="https://img.shields.io/bundlephobia/minzip/@skyra/discord-message-components?label=minzipped&logo=webpack&maxAge=3600&style=flat-square" alt="Minzipped Size">
</a>
</p>

<a href="https://depfu.com/github/skyra-project/discord-message-components?project_id=11733">
...
```ts
declare global {
  type DiscordMessageAvatars = Record<string, string> & Partial<{
    blue: string;
    gray: string;
    green: string;
    orange: string;
...
[favna's fork]: https://github.com/Favna/wc-discord-message
[rollup]: https://rollupjs.org/
[@stencil/react-output-target]: https://www.npmjs.com/package/@stencil/react-output-target
[`/src/components/`]: (https://github.com/favna/wc-discord-message/blob/master/src/components/)
