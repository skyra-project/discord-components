...
export default function FileAttachment(props: Record<string, unknown> = {}) {
	return html`<svg ${spread(props)} aria-hidden="false" fill="none" width="72" height="96" viewBox="0 0 72 96">${svgContent}</svg>`;
}
