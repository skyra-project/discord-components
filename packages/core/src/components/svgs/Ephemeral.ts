...
export const Ephemeral = html`
	<svg class="discord-message-ephemeral-icon" aria-hidden="false" width="16" height="16" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
		${svgContent}
	</svg>
`;
